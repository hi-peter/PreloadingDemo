...
public class FileUtils {
    ...
    public static void unzipJarFile(JarFile jarFile, File rootFile) {
        if (null == jarFile || null == rootFile) {
            com.meitu.plugin.utils.Logger.e("params invalid before unzip jar file !!!")
            return
        }
        if (!rootFile.exists()) {
            rootFile.mkdirs()
    ...
    public static void zipJarFile(File srcDir, File destFile) {
        if (null == srcDir) {
            com.meitu.plugin.utils.Logger.e("srcDir is null")
            return
        }

        if (!srcDir.exists()) {
            com.meitu.plugin.utils.Logger.e("srcDir is not exist")
            return
        }

        if (null == destFile) {
            com.meitu.plugin.utils.Logger.e("desFile is null")
            return
        }
